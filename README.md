# Course 5: Summative Lab

## Showcase Project Overview

This app allows users to select from already established playlists, or create their own! Users can find a new playlists and add songs, or delete the playlist.
